defmodule SlackWeb.DocumentationTest do
  use ExUnit.Case
  ...
  describe "new/2" do
    test "takes a documentation and filename, returns a module & function description" do
      ...
      module_functions = SlackWeb.Team.__info__(:functions)
    ...
    test "accepts versioned endpoints" do
      file_content =
        "#{__DIR__}/../../../lib/docs/oauth.v2.access.json"
        |> File.read!()
        |> Jason.decode!(%{})
      ...
      module_functions = SlackWeb.Oauth.V2.__info__(:functions)
